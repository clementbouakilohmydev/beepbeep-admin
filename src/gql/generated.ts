...
export type KeystoneAdminUiFieldMetaIsNonNull = "create" | "read" | "update"
...
export type KeystoneAdminUiFieldMetaListViewFieldMode = "hidden" | "read"
...
export type GetAuthenticatedItemQuery = {
  __typename?: "Query"
  authenticatedItem?: {
    __typename?: "User"
    id: string
...
export type ResetPasswordMutation = {
  __typename?: "Mutation"
  resetPassword: { __typename?: "ResetPasswordType"; success: boolean }
}
...
export type GetTicketsCountsQuery = {
  __typename?: "Query"
  pending?: number | null
  solved?: number | null
}
...
export type GetUsersCountsQuery = {
  __typename?: "Query"
  total?: number | null
  today?: number | null
  week?: number | null
...
export type GetUserQuery = {
  ...
  user?: {
    ...
    updatedAt?: string | null
    ratingsCount?: number | null
    avatar?: { __typename?: "File"; id: string; uri?: string | null } | null
    drivingLicense?: {
      __typename?: "DrivingLicense"
      id: string
      state?: string | null
      obtentionYear?: number | null
      createdAt?: string | null
      updatedAt?: string | null
      picture?: { __typename?: "File"; id: string; uri?: string | null } | null
    } | null
    insurance?: {
      __typename?: "Insurance"
      id: string
...
export type GetCoursesCountsQuery = {
  __typename?: "Query"
...
export type UpdateDrivingLicenseMutation = {
  __typename?: "Mutation"
...
export type GetAdminRevenueStatsQuery = {
  __typename?: "Query"
  adminRevenueStats: {
    __typename?: "AdminRevenueStats"
    revenue: number
...
export type GetAdminCoursesMetricsQuery = {
  __typename?: "Query"
  adminCoursesMetrics: {
    __typename?: "AdminCoursesMetrics"
...
export type GetAdminCoursesTrendQuery = {
  __typename?: "Query"
  adminCoursesTrend: Array<{
    __typename?: "AdminTrendPoint"
    date: string
    count: number
  }>
...
export type GetAdminUsersTrendQuery = {
  __typename?: "Query"
  adminUsersTrend: Array<{
    __typename?: "AdminTrendPoint"
    date: string
    count: number
  }>
...
export type GetAdminTicketsTrendQuery = {
  __typename?: "Query"
  adminTicketsTrend: Array<{
    __typename?: "AdminTrendPoint"
    date: string
    count: number
  }>
...
export type GetAdminDriversAverageRatingQueryVariables = Exact<{
  [key: string]: never
}>

export type GetAdminDriversAverageRatingQuery = {
  __typename?: "Query"
  adminDriversAverageRating?: number | null
}

export type GetAdminPendingDocumentsCountQueryVariables = Exact<{
  [key: string]: never
}>

export type GetAdminPendingDocumentsCountQuery = {
  __typename?: "Query"
  adminPendingDocumentsCount: number
}
...
export type GetAdminDailyAggregatesQuery = {
  __typename?: "Query"
  adminDailyAggregates: Array<{
    __typename?: "AdminDailyAggregate"
    date: string
    count: number
    revenue: number
...
export type GetTicketObjectsQueryVariables = Exact<{ [key: string]: never }>

export type GetTicketObjectsQuery = {
  __typename?: "Query"
  ticketObjects?: Array<{
    __typename?: "TicketObject"
    id: string
...
export type CreateTicketObjectMutationVariables = Exact<{
  object: Scalars["String"]["input"]
}>

export type CreateTicketObjectMutation = {
  __typename?: "Mutation"
  createTicketObject?: {
    __typename?: "TicketObject"
    id: string
...
export type UpdateTicketObjectMutationVariables = Exact<{
  id: Scalars["ID"]["input"]
  object: Scalars["String"]["input"]
}>

export type UpdateTicketObjectMutation = {
  __typename?: "Mutation"
  updateTicketObject?: {
    __typename?: "TicketObject"
    id: string
...
export type DeleteTicketObjectMutationVariables = Exact<{
  id: Scalars["ID"]["input"]
}>

export type DeleteTicketObjectMutation = {
  __typename?: "Mutation"
  deleteTicketObject?: { __typename?: "TicketObject"; id: string } | null
}
...
export type CreateLegalPageMutationVariables = Exact<{
  slug: Scalars["String"]["input"]
  name: Scalars["String"]["input"]
  description?: InputMaybe<Scalars["String"]["input"]>
}>

export type CreateLegalPageMutation = {
  __typename?: "Mutation"
  createPage?: { __typename?: "Page"; id: string; slug?: string | null } | null
}

export type UpdateLegalPageMutationVariables = Exact<{
  id: Scalars["ID"]["input"]
  name: Scalars["String"]["input"]
  description?: InputMaybe<Scalars["String"]["input"]>
}>

export type UpdateLegalPageMutation = {
  __typename?: "Mutation"
  updatePage?: {
    __typename?: "Page"
    id: string
...
export type CreatePageSectionMutation = {
  __typename?: "Mutation"
  createPageSection?: { __typename?: "PageSection"; id: string } | null
}

export type UpdatePageSectionMutationVariables = Exact<{
  id: Scalars["ID"]["input"]
  name: Scalars["String"]["input"]
  content: Scalars["String"]["input"]
}>

export type UpdatePageSectionMutation = {
  __typename?: "Mutation"
  updatePageSection?: {
    __typename?: "PageSection"
    id: string
...
export type DeletePageSectionMutation = {
  __typename?: "Mutation"
  deletePageSection?: { __typename?: "PageSection"; id: string } | null
}
...
>(
  ...
  >({
    ...
    mutationFn: (variables?: AuthenticateUserWithPasswordMutationVariables) =>
      graphqlClient<
        AuthenticateUserWithPasswordMutation,
        AuthenticateUserWithPasswordMutationVariables
      >(AuthenticateUserWithPasswordDocument, variables)(),
    ...options,
  })
}

useAuthenticateUserWithPasswordMutation.fetcher = (
  variables: AuthenticateUserWithPasswordMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    AuthenticateUserWithPasswordMutation,
    AuthenticateUserWithPasswordMutationVariables
  >(AuthenticateUserWithPasswordDocument, variables, options)
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAuthenticatedItemQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetAuthenticatedItemQuery,
      TError,
      TData
    >["queryKey"]
  }
  ...
  return useQuery<GetAuthenticatedItemQuery, TError, TData>({
    queryKey:
      variables === undefined
        ...
        : ["GetAuthenticatedItem", variables],
    queryFn: graphqlClient<
      GetAuthenticatedItemQuery,
      GetAuthenticatedItemQueryVariables
    >(GetAuthenticatedItemDocument, variables),
    ...options,
  })
}

useGetAuthenticatedItemQuery.getKey = (
  variables?: GetAuthenticatedItemQueryVariables
) =>
  variables === undefined
    ? ["GetAuthenticatedItem"]
...
useGetAuthenticatedItemQuery.fetcher = (
  variables?: GetAuthenticatedItemQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetAuthenticatedItemQuery, GetAuthenticatedItemQueryVariables>(
    GetAuthenticatedItemDocument,
    variables,
    options
  )
...
export const useEndSessionMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    EndSessionMutation,
    TError,
  ...
  >({
    ...
    mutationFn: (variables?: EndSessionMutationVariables) =>
      graphqlClient<EndSessionMutation, EndSessionMutationVariables>(
        EndSessionDocument,
        variables
      )(),
    ...options,
...
export const useResetPasswordMutation = <TError = unknown, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: (variables?: ResetPasswordMutationVariables) =>
      graphqlClient<ResetPasswordMutation, ResetPasswordMutationVariables>(
...
export const useGetUsersQuery = <TData = GetUsersQuery, TError = unknown>(
  ...
  return useQuery<GetUsersQuery, TError, TData>({
    ...
    queryFn: graphqlClient<GetUsersQuery, GetUsersQueryVariables>(
      GetUsersDocument,
      variables
    ),
    ...options,
...
useGetUsersQuery.fetcher = (
  ...
  graphqlClient<GetUsersQuery, GetUsersQueryVariables>(
    GetUsersDocument,
    variables,
    options
  )
...
export const useGetTicketsQuery = <TData = GetTicketsQuery, TError = unknown>(
  variables: GetTicketsQueryVariables,
  options?: Omit<
    UseQueryOptions<GetTicketsQuery, TError, TData>,
    "queryKey"
  > & { queryKey?: UseQueryOptions<GetTicketsQuery, TError, TData>["queryKey"] }
) => {
  return useQuery<GetTicketsQuery, TError, TData>({
    queryKey: ["GetTickets", variables],
    queryFn: graphqlClient<GetTicketsQuery, GetTicketsQueryVariables>(
      GetTicketsDocument,
      variables
    ),
    ...options,
...
useGetTicketsQuery.getKey = (variables: GetTicketsQueryVariables) => [
  "GetTickets",
  variables,
]

useGetTicketsQuery.fetcher = (
  variables: GetTicketsQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetTicketsQuery, GetTicketsQueryVariables>(
    GetTicketsDocument,
    variables,
    options
  )
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetTicketsCountsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<GetTicketsCountsQuery, TError, TData>["queryKey"]
  }
) => {
  return useQuery<GetTicketsCountsQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetTicketsCounts"]
        : ["GetTicketsCounts", variables],
    queryFn: graphqlClient<
      GetTicketsCountsQuery,
      GetTicketsCountsQueryVariables
    >(GetTicketsCountsDocument, variables),
    ...options,
  })
}

useGetTicketsCountsQuery.getKey = (
  variables?: GetTicketsCountsQueryVariables
) =>
  variables === undefined
    ? ["GetTicketsCounts"]
...
useGetTicketsCountsQuery.fetcher = (
  variables?: GetTicketsCountsQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetTicketsCountsQuery, GetTicketsCountsQueryVariables>(
    GetTicketsCountsDocument,
    variables,
    options
  )
...
export const useGetTicketQuery = <TData = GetTicketQuery, TError = unknown>(
  variables: GetTicketQueryVariables,
  options?: Omit<UseQueryOptions<GetTicketQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<GetTicketQuery, TError, TData>["queryKey"]
  }
) => {
  return useQuery<GetTicketQuery, TError, TData>({
    queryKey: ["GetTicket", variables],
    queryFn: graphqlClient<GetTicketQuery, GetTicketQueryVariables>(
      GetTicketDocument,
      variables
    ),
    ...options,
...
useGetTicketQuery.getKey = (variables: GetTicketQueryVariables) => [
  "GetTicket",
  variables,
]

useGetTicketQuery.fetcher = (
  variables: GetTicketQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetTicketQuery, GetTicketQueryVariables>(
    GetTicketDocument,
    variables,
    options
  )
...
export const useUpdateTicketMutation = <TError = unknown, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: (variables?: UpdateTicketMutationVariables) =>
      graphqlClient<UpdateTicketMutation, UpdateTicketMutationVariables>(
...
useUpdateTicketMutation.fetcher = (
  variables: UpdateTicketMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<UpdateTicketMutation, UpdateTicketMutationVariables>(
    UpdateTicketDocument,
...
>(
  options?: UseMutationOptions<
    CreateTicketMessageMutation,
    TError,
    CreateTicketMessageMutationVariables,
    TContext
  >
) => {
  return useMutation<
  ...
  >({
    ...
    mutationFn: (variables?: CreateTicketMessageMutationVariables) =>
      graphqlClient<
        CreateTicketMessageMutation,
        CreateTicketMessageMutationVariables
      >(CreateTicketMessageDocument, variables)(),
    ...options,
  })
}

useCreateTicketMessageMutation.fetcher = (
  variables: CreateTicketMessageMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    CreateTicketMessageMutation,
    CreateTicketMessageMutationVariables
  >(CreateTicketMessageDocument, variables, options)
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetUsersCountsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<GetUsersCountsQuery, TError, TData>["queryKey"]
  }
) => {
  return useQuery<GetUsersCountsQuery, TError, TData>({
    queryKey: ["GetUsersCounts", variables],
    queryFn: graphqlClient<GetUsersCountsQuery, GetUsersCountsQueryVariables>(
      GetUsersCountsDocument,
      variables
    ),
    ...options,
  })
...
useGetUsersCountsQuery.getKey = (variables: GetUsersCountsQueryVariables) => [
  "GetUsersCounts",
  variables,
]

useGetUsersCountsQuery.fetcher = (
  variables: GetUsersCountsQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetUsersCountsQuery, GetUsersCountsQueryVariables>(
    GetUsersCountsDocument,
    variables,
    options
  )
...
export const useGetUserQuery = <TData = GetUserQuery, TError = unknown>(
  ...
  return useQuery<GetUserQuery, TError, TData>({
    ...
    queryFn: graphqlClient<GetUserQuery, GetUserQueryVariables>(
      GetUserDocument,
      variables
    ),
    ...options,
...
useGetUserQuery.fetcher = (
  ...
  graphqlClient<GetUserQuery, GetUserQueryVariables>(
    GetUserDocument,
    variables,
    options
  )
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetCoursesCountsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<GetCoursesCountsQuery, TError, TData>["queryKey"]
  }
) => {
  return useQuery<GetCoursesCountsQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetCoursesCounts"]
        : ["GetCoursesCounts", variables],
    queryFn: graphqlClient<
      GetCoursesCountsQuery,
      GetCoursesCountsQueryVariables
    >(GetCoursesCountsDocument, variables),
    ...options,
  })
}

useGetCoursesCountsQuery.getKey = (
  variables?: GetCoursesCountsQueryVariables
) =>
  variables === undefined
    ? ["GetCoursesCounts"]
...
useGetCoursesCountsQuery.fetcher = (
  variables?: GetCoursesCountsQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetCoursesCountsQuery, GetCoursesCountsQueryVariables>(
    GetCoursesCountsDocument,
    variables,
    options
  )
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetCoursesCountsByPeriodQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
  ...
  return useQuery<GetCoursesCountsByPeriodQuery, TError, TData>({
    ...
    >(GetCoursesCountsByPeriodDocument, variables),
    ...options,
  })
}

useGetCoursesCountsByPeriodQuery.getKey = (
  variables: GetCoursesCountsByPeriodQueryVariables
) => ["GetCoursesCountsByPeriod", variables]

useGetCoursesCountsByPeriodQuery.fetcher = (
  variables: GetCoursesCountsByPeriodQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
...
export const useUpdateUserMutation = <TError = unknown, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: (variables?: UpdateUserMutationVariables) =>
      graphqlClient<UpdateUserMutation, UpdateUserMutationVariables>(
        UpdateUserDocument,
        variables
      )(),
    ...options,
...
>(
  options?: UseMutationOptions<
    UpdateDrivingLicenseMutation,
    TError,
    UpdateDrivingLicenseMutationVariables,
    TContext
  >
) => {
  return useMutation<
  ...
  >({
    ...
    mutationFn: (variables?: UpdateDrivingLicenseMutationVariables) =>
      graphqlClient<
        UpdateDrivingLicenseMutation,
        UpdateDrivingLicenseMutationVariables
      >(UpdateDrivingLicenseDocument, variables)(),
    ...options,
  })
}

useUpdateDrivingLicenseMutation.fetcher = (
  variables: UpdateDrivingLicenseMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    UpdateDrivingLicenseMutation,
    UpdateDrivingLicenseMutationVariables
  >(UpdateDrivingLicenseDocument, variables, options)
...
>(
  ...
  >({
    ...
    mutationFn: (variables?: UpdateInsuranceMutationVariables) =>
      graphqlClient<UpdateInsuranceMutation, UpdateInsuranceMutationVariables>(
...
useUpdateInsuranceMutation.fetcher = (
...
>(
  options?: UseMutationOptions<
    UpdateRegistrationDocumentMutation,
    TError,
    UpdateRegistrationDocumentMutationVariables,
    TContext
  >
) => {
  return useMutation<
  ...
  >({
    ...
    mutationFn: (variables?: UpdateRegistrationDocumentMutationVariables) =>
      graphqlClient<
        UpdateRegistrationDocumentMutation,
        UpdateRegistrationDocumentMutationVariables
      >(UpdateRegistrationDocumentDocument, variables)(),
    ...options,
  })
}

useUpdateRegistrationDocumentMutation.fetcher = (
  variables: UpdateRegistrationDocumentMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    UpdateRegistrationDocumentMutation,
    UpdateRegistrationDocumentMutationVariables
  >(UpdateRegistrationDocumentDocument, variables, options)
...
>(
  ...
  >({
    ...
    mutationFn: (variables?: UpdateCertificateMutationVariables) =>
      graphqlClient<
        UpdateCertificateMutation,
        UpdateCertificateMutationVariables
      >(UpdateCertificateDocument, variables)(),
    ...options,
  })
}

useUpdateCertificateMutation.fetcher = (
  variables: UpdateCertificateMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<UpdateCertificateMutation, UpdateCertificateMutationVariables>(
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAdminRevenueStatsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetAdminRevenueStatsQuery,
      TError,
      TData
    >["queryKey"]
  }
  ...
  return useQuery<GetAdminRevenueStatsQuery, TError, TData>({
    queryKey:
      variables === undefined
        ...
        : ["GetAdminRevenueStats", variables],
    queryFn: graphqlClient<
      GetAdminRevenueStatsQuery,
      GetAdminRevenueStatsQueryVariables
    >(GetAdminRevenueStatsDocument, variables),
    ...options,
  })
}

useGetAdminRevenueStatsQuery.getKey = (
  variables?: GetAdminRevenueStatsQueryVariables
) =>
  variables === undefined
    ? ["GetAdminRevenueStats"]
...
useGetAdminRevenueStatsQuery.fetcher = (
  variables?: GetAdminRevenueStatsQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetAdminRevenueStatsQuery, GetAdminRevenueStatsQueryVariables>(
    GetAdminRevenueStatsDocument,
    variables,
    options
  )
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAdminCoursesMetricsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetAdminCoursesMetricsQuery,
      TError,
      TData
    >["queryKey"]
  }
  ...
  return useQuery<GetAdminCoursesMetricsQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetAdminCoursesMetrics"]
        : ["GetAdminCoursesMetrics", variables],
    queryFn: graphqlClient<
      GetAdminCoursesMetricsQuery,
      GetAdminCoursesMetricsQueryVariables
    >(GetAdminCoursesMetricsDocument, variables),
    ...options,
  })
}

useGetAdminCoursesMetricsQuery.getKey = (
  variables?: GetAdminCoursesMetricsQueryVariables
) =>
  variables === undefined
    ? ["GetAdminCoursesMetrics"]
...
useGetAdminCoursesMetricsQuery.fetcher = (
  variables?: GetAdminCoursesMetricsQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    GetAdminCoursesMetricsQuery,
    GetAdminCoursesMetricsQueryVariables
  >(GetAdminCoursesMetricsDocument, variables, options)
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAdminCoursesTrendQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetAdminCoursesTrendQuery,
      TError,
      TData
    >["queryKey"]
  }
  ...
  return useQuery<GetAdminCoursesTrendQuery, TError, TData>({
    ...
    queryFn: graphqlClient<
      GetAdminCoursesTrendQuery,
      GetAdminCoursesTrendQueryVariables
    >(GetAdminCoursesTrendDocument, variables),
    ...options,
  })
}

useGetAdminCoursesTrendQuery.getKey = (
  variables: GetAdminCoursesTrendQueryVariables
) => ["GetAdminCoursesTrend", variables]

useGetAdminCoursesTrendQuery.fetcher = (
  variables: GetAdminCoursesTrendQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetAdminCoursesTrendQuery, GetAdminCoursesTrendQueryVariables>(
    GetAdminCoursesTrendDocument,
    variables,
    options
  )
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAdminUsersTrendQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetAdminUsersTrendQuery,
      TError,
      TData
    >["queryKey"]
  }
  ...
  return useQuery<GetAdminUsersTrendQuery, TError, TData>({
    ...
    queryFn: graphqlClient<
      GetAdminUsersTrendQuery,
      GetAdminUsersTrendQueryVariables
    >(GetAdminUsersTrendDocument, variables),
    ...options,
  })
}

useGetAdminUsersTrendQuery.getKey = (
  variables: GetAdminUsersTrendQueryVariables
) => ["GetAdminUsersTrend", variables]

useGetAdminUsersTrendQuery.fetcher = (
  variables: GetAdminUsersTrendQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetAdminUsersTrendQuery, GetAdminUsersTrendQueryVariables>(
    GetAdminUsersTrendDocument,
    variables,
    options
  )
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAdminTicketsTrendQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetAdminTicketsTrendQuery,
      TError,
      TData
    >["queryKey"]
  }
  ...
  return useQuery<GetAdminTicketsTrendQuery, TError, TData>({
    ...
    queryFn: graphqlClient<
      GetAdminTicketsTrendQuery,
      GetAdminTicketsTrendQueryVariables
    >(GetAdminTicketsTrendDocument, variables),
    ...options,
  })
}

useGetAdminTicketsTrendQuery.getKey = (
  variables: GetAdminTicketsTrendQueryVariables
) => ["GetAdminTicketsTrend", variables]

useGetAdminTicketsTrendQuery.fetcher = (
  variables: GetAdminTicketsTrendQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetAdminTicketsTrendQuery, GetAdminTicketsTrendQueryVariables>(
    GetAdminTicketsTrendDocument,
    variables,
    options
  )
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAdminDriversAverageRatingQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetAdminDriversAverageRatingQuery,
      TError,
      TData
    >["queryKey"]
  }
  ...
  return useQuery<GetAdminDriversAverageRatingQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetAdminDriversAverageRating"]
        : ["GetAdminDriversAverageRating", variables],
    queryFn: graphqlClient<
      GetAdminDriversAverageRatingQuery,
      GetAdminDriversAverageRatingQueryVariables
    >(GetAdminDriversAverageRatingDocument, variables),
    ...options,
  })
}

useGetAdminDriversAverageRatingQuery.getKey = (
  variables?: GetAdminDriversAverageRatingQueryVariables
) =>
  variables === undefined
    ? ["GetAdminDriversAverageRating"]
...
useGetAdminDriversAverageRatingQuery.fetcher = (
  variables?: GetAdminDriversAverageRatingQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    GetAdminDriversAverageRatingQuery,
    GetAdminDriversAverageRatingQueryVariables
  >(GetAdminDriversAverageRatingDocument, variables, options)
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAdminPendingDocumentsCountQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetAdminPendingDocumentsCountQuery,
      TError,
      TData
    >["queryKey"]
  }
  ...
  return useQuery<GetAdminPendingDocumentsCountQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetAdminPendingDocumentsCount"]
        : ["GetAdminPendingDocumentsCount", variables],
    queryFn: graphqlClient<
      GetAdminPendingDocumentsCountQuery,
      GetAdminPendingDocumentsCountQueryVariables
    >(GetAdminPendingDocumentsCountDocument, variables),
    ...options,
  })
}

useGetAdminPendingDocumentsCountQuery.getKey = (
  variables?: GetAdminPendingDocumentsCountQueryVariables
) =>
  variables === undefined
    ? ["GetAdminPendingDocumentsCount"]
...
useGetAdminPendingDocumentsCountQuery.fetcher = (
  variables?: GetAdminPendingDocumentsCountQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    GetAdminPendingDocumentsCountQuery,
    GetAdminPendingDocumentsCountQueryVariables
  >(GetAdminPendingDocumentsCountDocument, variables, options)
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAdminDocumentsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetAdminDocumentsQuery,
      TError,
      TData
    >["queryKey"]
  }
  ...
  return useQuery<GetAdminDocumentsQuery, TError, TData>({
    ...
    queryFn: graphqlClient<
      GetAdminDocumentsQuery,
      GetAdminDocumentsQueryVariables
    >(GetAdminDocumentsDocument, variables),
    ...options,
  })
}

useGetAdminDocumentsQuery.getKey = (
  variables: GetAdminDocumentsQueryVariables
) => ["GetAdminDocuments", variables]

useGetAdminDocumentsQuery.fetcher = (
  variables: GetAdminDocumentsQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetAdminDocumentsQuery, GetAdminDocumentsQueryVariables>(
    GetAdminDocumentsDocument,
    variables,
    options
  )
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAdminDailyAggregatesQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      GetAdminDailyAggregatesQuery,
      TError,
      TData
    >["queryKey"]
  }
  ...
  return useQuery<GetAdminDailyAggregatesQuery, TError, TData>({
    ...
    queryFn: graphqlClient<
      GetAdminDailyAggregatesQuery,
      GetAdminDailyAggregatesQueryVariables
    >(GetAdminDailyAggregatesDocument, variables),
    ...options,
  })
}

useGetAdminDailyAggregatesQuery.getKey = (
  variables: GetAdminDailyAggregatesQueryVariables
) => ["GetAdminDailyAggregates", variables]

useGetAdminDailyAggregatesQuery.fetcher = (
  variables: GetAdminDailyAggregatesQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    GetAdminDailyAggregatesQuery,
    GetAdminDailyAggregatesQueryVariables
  >(GetAdminDailyAggregatesDocument, variables, options)

export const GetTicketObjectsDocument = `
...
export const useGetTicketObjectsQuery = <
  TData = GetTicketObjectsQuery,
  TError = unknown,
>(
  variables?: GetTicketObjectsQueryVariables,
  options?: Omit<
    UseQueryOptions<GetTicketObjectsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<GetTicketObjectsQuery, TError, TData>["queryKey"]
  }
) => {
  return useQuery<GetTicketObjectsQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetTicketObjects"]
        : ["GetTicketObjects", variables],
    queryFn: graphqlClient<
      GetTicketObjectsQuery,
      GetTicketObjectsQueryVariables
    >(GetTicketObjectsDocument, variables),
    ...options,
  })
}

useGetTicketObjectsQuery.getKey = (
  variables?: GetTicketObjectsQueryVariables
) =>
  variables === undefined
    ? ["GetTicketObjects"]
...
useGetTicketObjectsQuery.fetcher = (
  variables?: GetTicketObjectsQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetTicketObjectsQuery, GetTicketObjectsQueryVariables>(
    GetTicketObjectsDocument,
    variables,
    options
  )

export const CreateTicketObjectDocument = `
...
export const useCreateTicketObjectMutation = <
  TError = unknown,
  TContext = unknown,
>(
  options?: UseMutationOptions<
    CreateTicketObjectMutation,
    TError,
    CreateTicketObjectMutationVariables,
    TContext
  >
) => {
  return useMutation<
    ...
    TContext
  >({
    mutationKey: ["CreateTicketObject"],
    mutationFn: (variables?: CreateTicketObjectMutationVariables) =>
      graphqlClient<
        CreateTicketObjectMutation,
        CreateTicketObjectMutationVariables
      >(CreateTicketObjectDocument, variables)(),
    ...options,
  })
}

useCreateTicketObjectMutation.fetcher = (
  variables: CreateTicketObjectMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    CreateTicketObjectMutation,
    CreateTicketObjectMutationVariables
  >(CreateTicketObjectDocument, variables, options)

export const UpdateTicketObjectDocument = `
...
export const useUpdateTicketObjectMutation = <
  TError = unknown,
  TContext = unknown,
>(
  options?: UseMutationOptions<
    UpdateTicketObjectMutation,
    TError,
    UpdateTicketObjectMutationVariables,
    TContext
  >
) => {
  return useMutation<
    ...
    TContext
  >({
    mutationKey: ["UpdateTicketObject"],
    mutationFn: (variables?: UpdateTicketObjectMutationVariables) =>
      graphqlClient<
        UpdateTicketObjectMutation,
        UpdateTicketObjectMutationVariables
      >(UpdateTicketObjectDocument, variables)(),
    ...options,
  })
}

useUpdateTicketObjectMutation.fetcher = (
  variables: UpdateTicketObjectMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    UpdateTicketObjectMutation,
    UpdateTicketObjectMutationVariables
  >(UpdateTicketObjectDocument, variables, options)

export const DeleteTicketObjectDocument = `
...
export const useDeleteTicketObjectMutation = <
  TError = unknown,
  TContext = unknown,
>(
  options?: UseMutationOptions<
    DeleteTicketObjectMutation,
    TError,
    DeleteTicketObjectMutationVariables,
    TContext
  >
) => {
  return useMutation<
    ...
    TContext
  >({
    mutationKey: ["DeleteTicketObject"],
    mutationFn: (variables?: DeleteTicketObjectMutationVariables) =>
      graphqlClient<
        DeleteTicketObjectMutation,
        DeleteTicketObjectMutationVariables
      >(DeleteTicketObjectDocument, variables)(),
    ...options,
  })
}

useDeleteTicketObjectMutation.fetcher = (
  variables: DeleteTicketObjectMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<
    DeleteTicketObjectMutation,
    DeleteTicketObjectMutationVariables
  >(DeleteTicketObjectDocument, variables, options)

export const GetLegalPagesDocument = `
    query GetLegalPages {
...
export const useGetLegalPagesQuery = <
  TData = GetLegalPagesQuery,
  TError = unknown,
>(
  variables?: GetLegalPagesQueryVariables,
  options?: Omit<
    UseQueryOptions<GetLegalPagesQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<GetLegalPagesQuery, TError, TData>["queryKey"]
  }
) => {
  return useQuery<GetLegalPagesQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetLegalPages"]
        : ["GetLegalPages", variables],
    queryFn: graphqlClient<GetLegalPagesQuery, GetLegalPagesQueryVariables>(
      GetLegalPagesDocument,
      variables
    ),
    ...options,
  })
...
useGetLegalPagesQuery.getKey = (variables?: GetLegalPagesQueryVariables) =>
  variables === undefined ? ["GetLegalPages"] : ["GetLegalPages", variables]

useGetLegalPagesQuery.fetcher = (
  variables?: GetLegalPagesQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetLegalPagesQuery, GetLegalPagesQueryVariables>(
    GetLegalPagesDocument,
    variables,
    options
  )

export const GetLegalPageDocument = `
...
export const useGetLegalPageQuery = <
  TData = GetLegalPageQuery,
  TError = unknown,
>(
  variables: GetLegalPageQueryVariables,
  options?: Omit<
    UseQueryOptions<GetLegalPageQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<GetLegalPageQuery, TError, TData>["queryKey"]
  }
) => {
  return useQuery<GetLegalPageQuery, TError, TData>({
    queryKey: ["GetLegalPage", variables],
    queryFn: graphqlClient<GetLegalPageQuery, GetLegalPageQueryVariables>(
...
useGetLegalPageQuery.getKey = (variables: GetLegalPageQueryVariables) => [
  "GetLegalPage",
  variables,
]

useGetLegalPageQuery.fetcher = (
  variables: GetLegalPageQueryVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<GetLegalPageQuery, GetLegalPageQueryVariables>(
    GetLegalPageDocument,
    variables,
    options
  )

export const CreateLegalPageDocument = `
    mutation CreateLegalPage($slug: String!, $name: String!, $description: String) {
...
export const useCreateLegalPageMutation = <
  TError = unknown,
  TContext = unknown,
>(
  options?: UseMutationOptions<
    CreateLegalPageMutation,
    TError,
    CreateLegalPageMutationVariables,
    TContext
  >
) => {
  return useMutation<
    ...
    TContext
  >({
    mutationKey: ["CreateLegalPage"],
    mutationFn: (variables?: CreateLegalPageMutationVariables) =>
      graphqlClient<CreateLegalPageMutation, CreateLegalPageMutationVariables>(
        CreateLegalPageDocument,
        variables
      )(),
    ...options,
  })
...
useCreateLegalPageMutation.fetcher = (
  variables: CreateLegalPageMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<CreateLegalPageMutation, CreateLegalPageMutationVariables>(
    CreateLegalPageDocument,
...
export const UpdateLegalPageDocument = `
    mutation UpdateLegalPage($id: ID!, $name: String!, $description: String) {
  updatePage(where: {id: $id}, data: {name: $name, description: $description}) {
    id
    name
    description
    updatedAt
...
>(
  options?: UseMutationOptions<
    UpdateLegalPageMutation,
    TError,
    UpdateLegalPageMutationVariables,
    TContext
  >
) => {
  return useMutation<
  ...
  >({
    ...
    mutationFn: (variables?: UpdateLegalPageMutationVariables) =>
      graphqlClient<UpdateLegalPageMutation, UpdateLegalPageMutationVariables>(
        UpdateLegalPageDocument,
        variables
      )(),
    ...options,
  })
...
useUpdateLegalPageMutation.fetcher = (
  variables: UpdateLegalPageMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<UpdateLegalPageMutation, UpdateLegalPageMutationVariables>(
    UpdateLegalPageDocument,
...
export const CreatePageSectionDocument = `
    mutation CreatePageSection($pageId: ID!, $name: String!, $content: String!) {
  createPageSection(
    data: {name: $name, content: $content, page: {connect: {id: $pageId}}}
  ) {
    id
  }
}
...
>(
  options?: UseMutationOptions<
    CreatePageSectionMutation,
    TError,
    CreatePageSectionMutationVariables,
    TContext
  >
) => {
  return useMutation<
  ...
  >({
    ...
    mutationFn: (variables?: CreatePageSectionMutationVariables) =>
      graphqlClient<
        CreatePageSectionMutation,
        CreatePageSectionMutationVariables
      >(CreatePageSectionDocument, variables)(),
    ...options,
  })
}

useCreatePageSectionMutation.fetcher = (
  variables: CreatePageSectionMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<CreatePageSectionMutation, CreatePageSectionMutationVariables>(
    CreatePageSectionDocument,
    variables,
    options
  )

export const UpdatePageSectionDocument = `
    mutation UpdatePageSection($id: ID!, $name: String!, $content: String!) {
  updatePageSection(where: {id: $id}, data: {name: $name, content: $content}) {
    id
    name
    content
    updatedAt
...
>(
  options?: UseMutationOptions<
    UpdatePageSectionMutation,
    TError,
    UpdatePageSectionMutationVariables,
    TContext
  >
) => {
  return useMutation<
  ...
  >({
    ...
    mutationFn: (variables?: UpdatePageSectionMutationVariables) =>
      graphqlClient<
        UpdatePageSectionMutation,
        UpdatePageSectionMutationVariables
      >(UpdatePageSectionDocument, variables)(),
    ...options,
  })
}

useUpdatePageSectionMutation.fetcher = (
  variables: UpdatePageSectionMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<UpdatePageSectionMutation, UpdatePageSectionMutationVariables>(
    UpdatePageSectionDocument,
    variables,
    options
  )
...
>(
  options?: UseMutationOptions<
    ...
    TError,
    DeletePageSectionMutationVariables,
    TContext
  >
) => {
  return useMutation<
    ...
    TContext
  >({
    mutationKey: ["DeletePageSection"],
    mutationFn: (variables?: DeletePageSectionMutationVariables) =>
      graphqlClient<
        DeletePageSectionMutation,
        DeletePageSectionMutationVariables
      >(DeletePageSectionDocument, variables)(),
    ...options,
  })
}

useDeletePageSectionMutation.fetcher = (
  variables: DeletePageSectionMutationVariables,
  options?: RequestInit["headers"]
) =>
  graphqlClient<DeletePageSectionMutation, DeletePageSectionMutationVariables>(
    DeletePageSectionDocument,
    variables,
    options
  )
